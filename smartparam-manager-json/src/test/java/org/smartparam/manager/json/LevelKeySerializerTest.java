 ...
 * @author Adam Dubiel
 */
public class LevelKeySerializerTest extends SerializerTest {

    @Test
    public void shouldSerializeLevelKeyAsPlainStringWithValue() {
        // given
        // when
        String json = serialize(new SimpleLevelKey("testKeyValue"));
